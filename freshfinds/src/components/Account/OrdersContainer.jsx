...
const OrdersContainer = () => {
  ...
  return (
    <div className="flex flex-row md:w-4/5 mr-5 ml-5 md:ml-2 my-5 lg:my-0 lg:ml-5 p-10 xl:p-5 3xl:p-10 rounded-xl shadow-lg justify-between custom-scrollbar overflow-hidden"

...
const ProductCard = ({ product }) => {
  return (
      <div className="w-3/4 sm:w-1/2 md:w-52 mx-4 rounded-xl shadow-xl m-4" style={{
          ...
          <div className="px-4 pt-2 pb-1 flex justify-between items-center">
              <div className="font-semibold text-md flex items-center">
                  {product.seller}
                  {product.rating && <img src={product.rating} alt="Rating" className="ml-2 h-6 w-6" />}
              </div>
          ...
          <div className="px-4 pt-2 pb-1">
              <div className="flex items-center mb-2">
                  <label htmlFor="quantity" className="mr-1.5 font-semibold text-sm">Quantity (in kgs):</label>
                  <input
                      id="quantity"
